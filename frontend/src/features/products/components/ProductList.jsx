import {FormControl, Grid, IconButton, InputLabel, MenuItem, Select, Stack, Typography, useMediaQuery, useTheme, Box } from '@mui/material'
...
import { ProductListSkeleton, SkeletonGlobalStyles } from '../../../components/Skeletons/Skeletons'
    ...
    {/* filters side bar */}
        ...
        <Stack mb={'3rem'}>
                ...
                <Stack rowGap={5} mt={is600?2:0}>
                    <Stack direction={is700 ? 'column' : 'row'} justifyContent={'space-between'} alignItems={'center'} sx={{ mt: 3, mb: 1.5, px: 1 }}>
                                                <Box sx={{ pl: is700 ? 0 : '25px', textAlign: is700 ? 'center' : 'left' }}>
                                                    <Typography variant={is700 ? 'h4' : 'h3'} sx={{ fontWeight:800, fontSize: is700 ? '1rem' : '2rem', letterSpacing:'0.5px' }}>Featured Listings</Typography>
                                                    <Typography sx={{ color: '#64748B', fontSize: is700 ? '0.85rem' : '1rem', mt:0.5 }}>Handpicked deals just for you</Typography>
                                                </Box>

                        <Stack flexDirection={'row'} justifyContent={'flex-end'} alignItems={'center'} columnGap={2} sx={{ mt: is700 ? 2 : 0, mr: is488 ? '1rem' : '2rem' }}>
                            <Stack width={'12rem'} sx={{ pr: '2px' }}>
