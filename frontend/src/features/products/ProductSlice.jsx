...
export const addProductAsync=createAsyncThunk("products/addProductAsync",async(data, {rejectWithValue})=>{
    try {
        ...
        console.log('ProductSlice: Product added successfully:', addedProduct)
        return addedProduct
    } catch(error) {
        console.error('ProductSlice: Error in addProductAsync:', error)
    ...
    extraReducers:(builder)=>{
        builder
            ...
            .addCase(addProductAsync.rejected,(state,action)=>{
                ...
                console.error('Product add rejected:', state.errors)
            })
