...
export const Cart = ({checkout}) => {
  ...
  return (
    <Stack justifyContent={'flex-start'} alignItems={'center'} mb={'5rem'} sx={{pt: { xs: '5rem', md: '4.5rem' }}}>
                    ...
                    checkout?(
                        <Stack rowGap={2} width={'100%'}>
                            ...
                            <Stack flexDirection={'row'} justifyContent={'space-between'}>
                                ...
                                <Typography>{formatINR(subtotal+SHIPPING+TAXES)}</Typography>
                            </Stack>
                        ...
                        <>
                            ...
                            <Stack>
                                <Typography variant='h6' fontWeight={500}>{formatINR(subtotal)}</Typography>
                            </Stack>
                        </>
                    )
                }
