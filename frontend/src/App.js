...
import AdminChatThreadPage from './pages/AdminChatThreadPage';
      ...
      <>
...

        {
          loggedInUser?.isAdmin?(
            ...
            <Route path='/admin/chats' element={<Protected><AdminChatPage/></Protected>}/>
            <Route path='/admin/chats/:conversationId' element={<Protected><AdminChatThreadPage/></Protected>}/>
            ...
            <Route path='/chat/admin' element={<Protected><BuyerChatPage/></Protected>}/>
